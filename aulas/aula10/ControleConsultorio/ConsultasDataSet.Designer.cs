...
namespace ControleConsultorio {
    ...
    public partial class ConsultasDataSet : global::System.Data.DataSet {
        ...
        public partial class PacienteDataTable : global::System.Data.TypedTableBase<PacienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public PacienteRow AddPacienteRow(string NOME_PACIENTE, string RUA, string NUMERO, string BAIRRO, string CIDADE, string CEP, string SEXO, string TELEFONE) {
...
namespace ControleConsultorio.ConsultasDataSetTableAdapters {
    ...
    public partial class ConsultasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Consultas] WHERE (([ID_CONSULTA] = @Original_ID_CONSULTA) AND ([ID_MEDICO] = @Original_ID_MEDICO) AND ([ID_PACIENTE] = @Original_ID_PACIENTE) AND ([DATA] = @Original_DATA) AND ([HORARIO] = @Original_HORARIO) AND ([RETORNO] = @Original_RETORNO))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Consultas] ([ID_MEDICO], [ID_PACIENTE], [DATA], [HORARIO], [RETORNO]) VALUES (@ID_MEDICO, @ID_PACIENTE, @DATA, @HORARIO, @RETORNO);
SELECT ID_CONSULTA, ID_MEDICO, ID_PACIENTE, DATA, HORARIO, RETORNO FROM Consultas WHERE (ID_CONSULTA = SCOPE_IDENTITY())";
...
SELECT ID_CONSULTA, ID_MEDICO, ID_PACIENTE, DATA, HORARIO, RETORNO FROM Consultas WHERE (ID_CONSULTA = @ID_CONSULTA)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ControleConsultorio.Properties.Settings.Default.ConsultasConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT Paciente.NOME_PACIENTE, Medico.NOME_MEDICO, Consultas.ID_CONSULTA, Consultas.ID_MEDICO, Consultas.ID_PACIENTE, Consultas.DATA, Consultas.HORARIO, Consultas.RETORNO
...
WHERE  (Consultas.DATA >= @dataInicio AND Consultas.DATA < DATEADD(DAY, 1, @dataFinal))
...
ORDER BY Consultas.DATA";
        ...
        public virtual int Fill(ConsultasDataSet.ConsultasDataTable dataTable) {
        ...
        public virtual ConsultasDataSet.ConsultasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual ConsultasDataSet.ConsultasDataTable retornarConsultas(System.DateTime dataInicio, System.DateTime dataFinal) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConsultasDataSet.ConsultasDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID_CONSULTA, int Original_ID_MEDICO, int Original_ID_PACIENTE, System.DateTime Original_DATA, System.DateTime Original_HORARIO, bool Original_RETORNO) {
        ...
        public virtual int Insert(int ID_MEDICO, int ID_PACIENTE, System.DateTime DATA, System.DateTime HORARIO, bool RETORNO) {
        ...
        public virtual int Update(int ID_MEDICO, int ID_PACIENTE, System.DateTime DATA, System.DateTime HORARIO, bool RETORNO, int Original_ID_CONSULTA, int Original_ID_MEDICO, int Original_ID_PACIENTE, System.DateTime Original_DATA, System.DateTime Original_HORARIO, bool Original_RETORNO, int ID_CONSULTA) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ID_MEDICO, int ID_PACIENTE, System.DateTime DATA, System.DateTime HORARIO, bool RETORNO, int Original_ID_CONSULTA, int Original_ID_MEDICO, int Original_ID_PACIENTE, System.DateTime Original_DATA, System.DateTime Original_HORARIO, bool Original_RETORNO) {
    ...
    public partial class MedicoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_VALOR_CONSULTA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 2, "VALOR_CONSULTA", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@VALOR_CONSULTA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 2, "VALOR_CONSULTA", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
...
SELECT ID_MEDICO, NOME_MEDICO, TELEFONE_MEDICO, VALOR_CONSULTA FROM Medico WHERE (ID_MEDICO = @ID_MEDICO)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@VALOR_CONSULTA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 2, "VALOR_CONSULTA", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID_MEDICO", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID_MEDICO", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_VALOR_CONSULTA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 2, "VALOR_CONSULTA", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ConsultasDataSet.MedicoDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ConsultasDataSet.MedicoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ConsultasDataSet.MedicoDataTable dataTable = new ConsultasDataSet.MedicoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConsultasDataSet.MedicoDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class PacienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Paciente] WHERE (([ID_PACIENTE] = @Original_ID_PACIENTE) AND ([NOME_PACIENTE] = @Original_NOME_PACIENTE) AND ([RUA] = @Original_RUA) AND ([NUMERO] = @Original_NUMERO) AND ([BAIRRO] = @Original_BAIRRO) AND ([CIDADE] = @Original_CIDADE) AND ([CEP] = @Original_CEP) AND ([SEXO] = @Original_SEXO) AND ([TELEFONE] = @Original_TELEFONE))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID_PACIENTE", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID_PACIENTE", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Paciente] ([NOME_PACIENTE], [RUA], [NUMERO], [BAIRRO], [CIDADE], [CEP], [SEXO], [TELEFONE]) VALUES (@NOME_PACIENTE, @RUA, @NUMERO, @BAIRRO, @CIDADE, @CEP, @SEXO, @TELEFONE);
SELECT ID_PACIENTE, NOME_PACIENTE, RUA, NUMERO, BAIRRO, CIDADE, CEP, SEXO, TELEFONE FROM Paciente WHERE (ID_PACIENTE = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Paciente] SET [NOME_PACIENTE] = @NOME_PACIENTE, [RUA] = @RUA, [NUMERO] = @NUMERO, [BAIRRO] = @BAIRRO, [CIDADE] = @CIDADE, [CEP] = @CEP, [SEXO] = @SEXO, [TELEFONE] = @TELEFONE WHERE (([ID_PACIENTE] = @Original_ID_PACIENTE) AND ([NOME_PACIENTE] = @Original_NOME_PACIENTE) AND ([RUA] = @Original_RUA) AND ([NUMERO] = @Original_NUMERO) AND ([BAIRRO] = @Original_BAIRRO) AND ([CIDADE] = @Original_CIDADE) AND ([CEP] = @Original_CEP) AND ([SEXO] = @Original_SEXO) AND ([TELEFONE] = @Original_TELEFONE));
SELECT ID_PACIENTE, NOME_PACIENTE, RUA, NUMERO, BAIRRO, CIDADE, CEP, SEXO, TELEFONE FROM Paciente WHERE (ID_PACIENTE = @ID_PACIENTE)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID_PACIENTE, NOME_PACIENTE, RUA, NUMERO, BAIRRO, CIDADE, CEP, SEXO, TELEFO" +
                "NE FROM dbo.Paciente";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ID_PACIENTE, string Original_NOME_PACIENTE, string Original_RUA, string Original_NUMERO, string Original_BAIRRO, string Original_CIDADE, string Original_CEP, string Original_SEXO, string Original_TELEFONE) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string NOME_PACIENTE, string RUA, string NUMERO, string BAIRRO, string CIDADE, string CEP, string SEXO, string TELEFONE) {
        ...
        public virtual int Update(
            ...
            if ((Original_NOME_PACIENTE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_NOME_PACIENTE));
            }
            if ((Original_RUA == null)) {
                throw new global::System.ArgumentNullException("Original_RUA");
            }
        ...
        public virtual int Update(
                    ...
                    string Original_SEXO, 
                    string Original_TELEFONE) {
            return this.Update(NOME_PACIENTE, RUA, NUMERO, BAIRRO, CIDADE, CEP, SEXO, TELEFONE, Original_ID_PACIENTE, Original_NOME_PACIENTE, Original_RUA, Original_NUMERO, Original_BAIRRO, Original_CIDADE, Original_CEP, Original_SEXO, Original_TELEFONE, Original_ID_PACIENTE);
        }
    }
