...
namespace Academia
{
    public partial class ucControleAlunos : UserControl
    {
        private readonly ucAlunos formulario;

        public ucControleAlunos(ucAlunos formulario)
        {
            InitializeComponent();
        ...
        private void ucControleAlunos_Load(object sender, EventArgs e)
        {
        ...
        private void frmControleAlunos_FormClosed(object sender, FormClosedEventArgs e) => formulario.ListaAlunos();
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lblUsuarioCarregado.Text = $"SCA - Controle de Alunos :: {txtNome.Text} ::";
        ...
        public void ExibirAluno(DataGridView aluno)
        {
            try
            {
                ...
                lblUsuarioCarregado.Text = $"SCA - Controle de Alunos :: {drv["NOME_ALUNO"]} ::";
